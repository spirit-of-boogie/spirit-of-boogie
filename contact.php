...
$address = "bookings@spiritofboogie.com";
$e_subject = 'You have an enquiry from ' . $name . '.';

$e_body = "You have been contacted by $name. Here is their message:" . PHP_EOL . PHP_EOL;
$e_content = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name by email at $email";
